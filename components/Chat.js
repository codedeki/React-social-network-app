import React, { useEffect, useContext, useRef, useImperativeHandle } from "react";
...
// connect to our backend server port
...
//scroll to top with each new chat message in array
  useEffect(() => {
  ...
  return (
    ...
    <div id="chat" className="chat-log" ref={chatLog}>
      {state.chatMessages.map((message, i) => {
        ...
        return (
          <div key={i} className="chat-other">
